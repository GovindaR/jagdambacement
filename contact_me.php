<?php
$recipient_email    = "govindaranamagar44@gmail.com"; //recepient
$from_email         = "info@jagdambacement.com"; //from email using site domain.
...
if($_POST){
    ...
    $attachments = $_FILES['file_attach']['tmp_name'];
    ...
    if(strlen($sender_address )<3){ //check emtpy subject
