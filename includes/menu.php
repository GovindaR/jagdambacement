<div id="menuWrap">
  ...
  <div class="menu">
    ...
    <ul>
      ...
      <li class="our--products"><a href="#">Our Products <span>&nbsp;</span></a>
...
order by id desc limit 1";
        ...
        <div class="dropdownBox threeCol <?php echo($i==3)?"last-child":"";?>">
          ...
          <div class="txt"> <img src="uploads/<?php echo $product_rows['Image'];?>" />
        ...
        <div class="dropdown">
          ...
          <div class="dropdownWrap">
            ...
            <div class="dropdownBox threeCol <?php echo ($i%3==0)?"last-child":"";?>">
              ...
              <div class="txt"> <img src="<?php echo URL_PATH."uploads/".$porfolio_rows['Image'];?>"  />
  ...
  <ul id="showMenu">
        <li><a href="index.php">Home</a></li>
                   ...
                   <li><a class="active__show">About us</a>
                     <ul class="extra__show">
                    <li>
                      <a href="inner.php?title=<?php echo 'company-profile'; ?>">Company profile</a>
                      <!-- <a href="page.php?id=<?php echo $pageid; ?>">This is page link<a> -->
                    </li>
                    <li>
                      <a href="inner.php?title=<?php echo 'vision-and-mission'; ?>">vision and mission</a>
                    </li>
                    <li>
                      <a href="inner.php?title=<?php echo 'quality-assurance'; ?>">Quality Assurance</a>
                    </li>
                    <li>
                      <a href="inner.php?title=<?php echo 'packaging'; ?>">Quality Assurance</a>
                    </li>
                  </ul>
                   </li>

                  <li><a class="active__show1">Our Plant</a>
                     <ul class="extra__show">
                    <li>
                      <a href="plant.php?title=<?php echo 'jagdamba-cement-industries-p-ltd'; ?>">Jagdamba Cement Industries p.ltd</a>
                    </li>
                    <li>
                      <a href="plant.php?title=<?php echo 'shubha-shree-jagdamba-cement-mills-p-ltd'; ?>">Shubha Shree Jagdamba Cement Mills p.ltd</a>
                    </li>
                  </ul>
                  </li>

                  <li><a class="active__show2">Our Products</a>
                    <ul class="extra__show">
                      <li>
                        <a href="product.php?title=<?php echo 'portland-pozzolana-cement-ppc'; ?>">Portland Pozzolana Cement</a>
                      </li>
                      <li>
                        <a href="product.php?title=<?php echo 'ordinary-portland-cement-opc'; ?>">Ordinary Portland Cement</a>
                      </li>
                      <li>
                        <a href="product.php?title=<?php echo 'portland-slag-cement-psc'; ?>">Shubha Shree Jagdamba Cement Mills p.ltd</a>
                      </li>
                  </ul>
                  </li>
                  ...
                  <li><a class="active__show3">Portfolio</a>
                   <ul class="extra__show">
                      <li>
                 ...
                 <li><a class="active__show4">Technical Support</a>
                  <ul class="extra__show">
                      <li>
                        <a href="nner.php?title=<?php echo 'jagdamba-construction-practices';?>">Jagdamba Construction Practices</a>
                      </li>
                      <li>
