...
<div class="menu__header">
  ...
  <div class="in-imageWrap">

    <iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=tinkune+kathmanu&amp;sll=37.0625,-95.677068&amp;sspn=56.200193,79.013672&amp;ie=UTF8&amp;hq=&amp;hnear=&amp;t=m&amp;ll=27.685523,85.348835&amp;spn=0.00665,0.002146&amp;z=16&amp;output=embed"></iframe>
  ...
  <div style="padding: 15px">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 contact__border our__product">
<small style="margin-bottom: 10px;">
        <h1>Help us to serve you better</h1>
        </small>
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-md-3">
            ...
            <h3>Jagdamba Cement </h3>

            <div class="contactAddress"> <i class="glyphicon glyphicon-map-marker"></i>

              <h4>Corporate Office</h4>

              <p>Neupane Tower, 6th Floor<br />
            ...
            <p><span class="glyphicon glyphicon-earphone"> </span> +977.1.411 1500, 411 1550<br />

              <span class="glyphicon glyphicon-print"> </span> +977.1.411 1634 <br />

              <span class="glyphicon glyphicon-envelope"> </span> info@jagdambacement.com</p>
            ...
            <div class="contactAddress"> <i class="glyphicon glyphicon-map-marker"></i>
              ...
              <p>Chhata Pipra Chorni-4<br />

                Parsa, Nepal</p>

            </div>

            <p><span class="glyphicon glyphicon-earphone"> </span> +977.051.580250, 580510<br />

              <span class="glyphicon glyphicon-print"> </span> +977.051.580510 <br />

              <span class="glyphicon glyphicon-envelope"> </span> ssjcm@wlink.com.np</p>

            <br />

            <div class="contactAddress"> <i class="glyphicon glyphicon-map-marker"></i>

              <h4>Bhairahawa Unit</h4>

              <p>Gonaha - 7, Bhairahawa<br />

                Rupandehi, Nepal</p>

            </div>

            <p><span class="glyphicon glyphicon-earphone"> </span> +977.071.622246, 622258<br />

              <span class="glyphicon glyphicon-envelope"> </span> jcipl@ntc.net.np</p>
...
if(isset($msg1) and $msg1=="invalid_captcha")

{

	?>

              <p class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>

Security code is incorrect.</p>

              <?php	

}

else if(isset($msg1) and $msg1=="mailsent")

{

	?>

              <p class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Thanks! Your request has been sent.</p>
...
?>
              ...
              <form action="" method="post">
                ...
                <input type="text" required='required' placeholder='SUBJECT*' name="Subject" id="" value="" class="form-control last-child" />

                <div class="clearfix"></div>

                <textarea required='required' placeholder='Feedback & Suggestions*' name="commnet" rows="10" class="form-control" ></textarea>

                <span class="cpta_holder"><img data-src="captcha/captcha_image.php" width="100" height="20" align="left"/></span>

                <input type="text" required='required' placeholder='SECURITY CODE*' name="security_code" id="security_code" tabindex="10" value="" autocomplete="off" />
          ...
          <div class="col-sm-1">
            ...
            <div class="socialNet"> <a href="https://www.facebook.com/jagdamba.cement" target="_blank"><img data-src="img/facebook.png" width="48" height="48" class="img-responsive" /></a> 

              <!--<a href="#"><img src="img/google.png" width="48" height="48" /></a>

            <a href="#"><img src="img/twitter.png" width="48" height="48" /></a>--> 
