      ...
      <div class="wrap">
        ...
        <div class="addTable">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="addTable">
            ...
            <tr>
              <th valign="top" class="right">Parent Id</th>
              <td colspan="2"><select class="selectBox small" name="Position" id="Position">
              <option value="0">None</option>
              <?php
				$position_stmt = $conn->prepare("SELECT * FROM content");
            ...
            <tr>
              ...
              <td colspan="2">
              <textarea class="form-control editor" id="Details" name="Details"><?php echo isset($rows['Details'])?$rows['Details']:NULL;?></textarea></td>
            </tr>
            <tr>
              <th valign="top" class="right">Template</th>
              <td colspan="2"><input type="text" name="Urls" id="Urls" class="textBox small" value="<?php echo isset($rows['Urls'])?$rows['Urls']:NULL; ?>" <?php //echo $border;?> /> &nbsp; Note:</strong> Applicable for Webmaster only. Please do not change.</td>
            </tr>
            <tr>
