        ...
        <div class="list">         
          <table width="100%" border="0" cellpadding="0" cellspacing="1">
            <tr>
              ...
              <th width="10%" class="right">Posted Date</th>
              <th width="7%" class="right">Action</th>
            </tr>
            
            <?php
            $i=1;
			$list_sql ="SELECT *, DATE_FORMAT(PostedDate,'%b %d, %Y') AS posted_date FROM ".$table_name."";
            ...
            <tr>
              ...
              <td><?php echo ($list_rows['TypeId']==NULL)?'':$kml->getTitle('m_d_type',$list_rows['TypeId']); ?></td>
              <td><?php echo $kml->getTitle('m_d_category',$list_rows['CatId']); ?></td>
