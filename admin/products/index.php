...
<script src="//ajax.googleapis.com/ajax/libs/jquery/2.0.1/jquery.min.js" type="text/javascript" charset="utf-8"></script>
    ...
    <div id="content">
      <div class="wrap">
        ...
        <div class="list">         
          <table width="100%" border="0" cellpadding="0" cellspacing="1">
            <tr>
              ...
              <th width="9%" class="right" <?php echo $order_display?>>Order By</th>
              <th width="11%" class="right">Posted Date</th>
              <th width="6%" class="right">Action</th>
            </tr>
            ...
            <tr>
              ...
              <td class="right" <?php echo $order_display?>><input name="orderBy[]" type="text" id="orderBy[]" size="2" maxlength="2" value="<?php print $i;?>" />
                  <input type="hidden" name="hdnId[]" id="hdnId[]" value="<?php print $list_rows['Id'];?>" /></td>
        ...
        <input type="hidden" name="hdnNumRows" id="hdnNumRows" value="<?php print $list_stmt->rowCount();?>" />
         <input type="hidden" name="hdnParentId" id="hdnParentId" value="<?php print isset($_GET['type'])?$_GET['type']:NULL;?>" />
       </form>  
