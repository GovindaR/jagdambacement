...
$letter = array(
	'thumb_image_name' => $_FILES['Letter']['name'],
	'thumb_image_tmp' => $_FILES['Letter']['tmp_name'],
...
if(isset($_POST['btnAdd'])){
	$kml->insertData($table_name,$value,$_POST['Title'],$image,$letter);
}// ADD
if(isset($_POST['btnUpdate'])){
	$kml->updateData($table_name,$_GET['id'],$value,$image,$letter);
}// UPDATE
      ...
      <div class="wrap">
        ...
        <div class="addTable">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="addTable">
            <tr>
              <th width="12%" valign="top" class="right">Name</th>
            ...
            <tr>
              <th valign="top" class="right">Address</th>
              <td colspan="2"><input type="text" name="Address" id="Address" class="textBox medium" value="<?php echo isset($rows['Address'])?$rows['Address']:NULL; ?>" /></td>
            </tr>
            <tr>
              <th valign="top" class="right">Image</th>
              <td colspan="2"><input type="file" name="Image" id="Image" class="" /> Image Size: 100 x 100px</td>
            </tr>
            <tr>
              <th valign="top" class="right">Letter</th>
              <td colspan="2"><input type="file" name="Letter" id="Letter" class="" /></td>
            </tr>
            <tr>
